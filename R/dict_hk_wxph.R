...
#'
#' @description
#' Provides the dictionary of HKO weather camera stations, with the following columns
#' * code = Code name of the tidal stations
#' * full_name = Name of the tidal stations, in English
#'
#' @return `tibble`, with columns `code`, `full_name`
#' @export
#'
#' @examples dict_hk_wxph()
dict_hk_wxph = function(){
  return(tibble::tibble(LFS = "Lau Fau Shan (W)",
                        WLP = "Wetland Park (NE)",
