#' @title
#' HK weather - Downloading rainfall nowcast information
#'
#' @description
...
#' @export
#'
#' @examples load_hk_rain()
load_hk_rain = function(time = seq.POSIXt(from = Sys.time(), by = "-10 min", length.out = 1009),
                        lan = "en",
                        list_fail = T,
                        dir = getwd(),
                        attempt = 5L,
