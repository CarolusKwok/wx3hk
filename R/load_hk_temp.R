#' @title
#' HK weather - Downloading air temperature information
#'
#' @description
...
#' @export
#'
#' @examples load_hk_temp()
load_hk_temp = function(time = seq.POSIXt(from = wx3hk::hk_time(),
                                          by = "-10 min",
                                          length.out = 1008),
                        lan = "en",
                        list_fail = T,
